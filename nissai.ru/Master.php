            ...
            <table id="masterTable">
                <thead>
                    <tr>
                        ...
                        <th onclick="sortTable(2)">Дата заявки</th>
                        <th onclick="sortTable(3)">Срок исполнения</th>
                ...
                <tbody>
                    ...
                    $sql = "SELECT id, client_name, order_name, request_date, execution_date, status FROM orders";
        ...
        editableCells.forEach(cell => {
            ...
            cell.addEventListener('blur', function() {
                ...
                .then(data => {   if (data.success) {
                        console.log('отправленно успешно'); // Data updated succyessfull Failed to update data
                    } else {
